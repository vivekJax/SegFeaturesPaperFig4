    ...
    \begin{minipage}[t]{0.33\textwidth}
        ...
        \adjustbox{height=2.5in,valign=f,center}{
            ...
            \begin{tabular}{>{\centering\arraybackslash}p{0.25cm} c l c}
                ...
                \textcolor[HTML]{d62728}{\rule{0.25cm}{0.25cm}} & \includegraphics[width=18px]{../icons/Segmentation_colorized_red.pdf} & Segmentation + JABS & 0.850 \\
                \midrule
                ...
                \textcolor[HTML]{7f7f7f}{\rule{0.25cm}{0.25cm}} & \includegraphics[width=18px]{../icons/mars_no_front_paws_no_center_spine_Skeleton_colorized_red.pdf} & MARS & 0.900 \\
                \rowcolor{rowlight}
                ...
                \textcolor[HTML]{c5b0d5}{\rule{0.25cm}{0.25cm}} & \includegraphics[width=18px]{../icons/nose_butt_Skeleton_colorized_red.pdf} & Nose and Base Tail & 0.870 \\
